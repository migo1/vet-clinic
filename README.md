...
**[Vet Clinic]** is a database that keeps records of various animals with attributes such as names, date of birth, escaped attempts etc.
...
Feel free to check the [issues page](https://github.com/migo1/vet-clinic/issues).
